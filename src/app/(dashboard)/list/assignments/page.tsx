...
type AssignmentList = Assignment & {
  lesson: {
    ...
    class: Class
    teacher: Teacher
  } & { students: Student } & { parent: Parent }
}
      ...
      include: {
        lesson: {
          select: {
            ...
            teacher: { select: { name: true, surname: true, clerkId: true } },
  ...
  return (
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
      ...
      <div className='flex items-center justify-between'>
        <h1 className='hidden md:block'>All Assignments</h1>
